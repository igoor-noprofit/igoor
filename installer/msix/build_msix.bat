...
rem published package of different content. Done via the XML DOM in a .ps1 -
rem inline cmd/PowerShell quoting twice corrupted MinVersion by accident.
powershell -NoProfile -ExecutionPolicy Bypass -File "!HERE!sync_manifest_version.ps1" -Manifest "!LAYOUT!\AppxManifest.xml" -Version "!PKG_VERSION!"
